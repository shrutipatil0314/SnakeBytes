...
if match_obj is not None:
    # Match objects expose useful methods for inspecting the match.
    print(match_obj)
    print("Matched text:", match_obj.group())
    print("Match span:", match_obj.span())
else:
    print("Not Found")

# Search for a numeric pattern and handle the result safely.
number_match = re.search(r"13", message)
if number_match is not None:
    print("Found:", number_match.group())
else:
    print("Not Found")
